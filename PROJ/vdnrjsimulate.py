...
rightletters= { " ":[1.5,-4], "z":[-2,2], "y":[-1,2], "i":[0,2], "m":[1,2], "f":[2,2], "g":[-1.5,0], "t":[-0.5,0], "e":[0.5,0], "w":[-1.5,0], "q":[-1.5,-2], "u":[-0.5,-2], "c":[-0.5,-2], "x":[-2.5,-2]}
leftletters = {" ":[-1.5,-4], 'v':[-2, 2], 'd':[-1,2],"n": [0,2], "r": [1,2], "j": [2,2], "p": [-1.5, 0], "o": [-0.5,0], "h":[0.5,0], "k": [1.5,0],"l": [2.5, 0], "s": [-0.5, -2], "a": [0.5, -2], "b": [1.5,-2] }
