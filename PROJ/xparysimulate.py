...
rightletters= { " ":[1.5,-4], "z":[-2,2], "m":[-1,2], "n":[0,2], "d":[1,2], "f":[2,2], "l":[-1.5,0], "t":[-0.5,0], "e":[0.5,0], "w":[-1.5,0], "j":[-1.5,-2], "c":[-0.5,-2], "u":[-0.5,-2], "v":[-2.5,-2]}
leftletters = {" ":[-1.5,-4], 'x':[-2, 2], 'p':[-1,2],"a": [0,2], "r": [1,2], "y": [2,2], "b": [-1.5, 0], "o": [-0.5,0], "h":[0.5,0], "s": [1.5,0],"q": [2.5, 0], "k": [-0.5, -2], "i": [0.5, -2], "g": [1.5,-2] }
